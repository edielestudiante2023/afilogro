        ...
        if ($usuario) {
            ...
            if (password_verify($password, $usuario['password'])) {
                ...
                switch ($usuario['id_roles']) {
                    case 1:
                        return redirect()->to(base_url('superadmin/superadmindashboard'));
                    case 2:
                        return redirect()->to(base_url('admin/admindashboard'));
                    case 3:
                        return redirect()->to(base_url('jefatura/jefaturadashboard'));
                    case 4:
                        return redirect()->to(base_url('trabajador/trabajadordashboard'));
                    default:
