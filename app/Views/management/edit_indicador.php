        ...
        <form action="<?= base_url('indicadores/edit/' . $indicador['id_indicador']) ?>" method="post">
            ...
            <div class="mb-3">
                ...
                <select name="tipo_meta" class="form-select" required>
                    ...
                    <option value="fija" <?= old('tipo_meta', $indicador['tipo_meta']) == 'fija' ? 'selected' : '' ?>>Fija</option>
                    <option value="comparativa" <?= old('tipo_meta', $indicador['tipo_meta']) == 'comparativa' ? 'selected' : '' ?>>Comparativa</option>
                </select>
            </div>
