...
<head>
    ...
    <style>
        /* Ajustes de altura y padding para encajar en Bootstrap 5 */
...
<body>
                            ...
                            <select id="id_perfil_cargo" name="id_perfil_cargo"
                                ...
                                <?php foreach ($perfiles_cargo as $p): ?>
                                    <option value="<?= esc($p['id_perfil_cargo']) ?>"
                                        <?= old('id_perfil_cargo') == $p['id_perfil_cargo'] ? 'selected' : '' ?>>
                                        <?= esc($p['nombre_cargo']) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
    ...
    $(document).ready(function() {
        ...
        // Inicializar todos los select2 con tema Bootstrap 5 y placeholder dinámico
